...
{
    {
        ...
        assert(std::is_permutation(forward_iterator<const int*>(ia),
                                   ...
                                   std::equal_to<const int>()) == true);
#if TEST_STD_VER >= 14
        assert(cpp14::is_permutation(forward_iterator<const int*>(ia),
                                   forward_iterator<const int*>(ia + sa),
                                   forward_iterator<const int*>(ib),
    ...
    }
    {
        ...
        comparison_count = 0;
        assert(cpp14::is_permutation(random_access_iterator<const int*>(ia),
    ...
    }
    {
      ...
      assert(std::is_permutation(forward_iterator<const S*>(a),
                                 ...
                                 eq()));
#if TEST_STD_VER >= 14
      assert(cpp14::is_permutation(forward_iterator<const S*>(a),
                                 forward_iterator<const S*>(a + sa),
                                 forward_iterator<const S*>(b),
