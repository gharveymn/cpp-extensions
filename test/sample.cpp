...
void test() {
  ...
  std::minstd_rand g;
  SampleIterator end;
  end = cpp17::sample(PopulationIterator(ia),
...
void test_empty_population() {
  ...
  std::minstd_rand g;
  SampleIterator end =
    cpp17::sample(PopulationIterator(ia), PopulationIterator(ia),
                SampleIterator(oa), os, g);
  assert(end.base() == oa);
}
...
void test_empty_sample() {
  ...
  std::minstd_rand g;
  SampleIterator end =
    cpp17::sample(PopulationIterator(ia), PopulationIterator(ia + is),
